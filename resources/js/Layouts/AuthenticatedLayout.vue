...
<template>
    <div class="bg-gray-50/50 font-sans antialiased text-gray-800 min-h-screen" style="font-family: 'Poppins', sans-serif;">
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <header class="h-20 bg-white border-b border-gray-100 flex items-center justify-between px-4 sm:px-8 z-10">
                    ...
                    <div class="flex items-center gap-4">
                        <div v-if="user" class="flex items-center gap-2 sm:gap-3 sm:pl-4 sm:border-l sm:border-gray-100">
                            ...
                            <div v-else class="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-orange-500 text-white flex items-center justify-center font-bold text-xs shadow-sm">
