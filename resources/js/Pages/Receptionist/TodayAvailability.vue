...
<template>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <Link :href="route('appointments.index')" class="inline-flex items-center gap-2 bg-gray-100 text-gray-700 px-4 py-2 rounded-xl font-semibold text-xs hover:bg-gray-200 transition">
            ...
            <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div v-for="slot in availabilities" :key="slot.id" class="border border-gray-100 rounded-2xl p-5 bg-gray-50/40 flex flex-col justify-between gap-4 shadow-2xs hover:border-orange-200 hover:bg-white transition group">
                    ...
                    <div class="pt-3 border-t border-gray-100 flex items-center justify-between">
                        ...
                        <Link :href="route('appointments.create', { doctor_id: slot.doctor_id })" class="inline-flex items-center gap-1.5 bg-orange-500 text-white px-3.5 py-1.5 rounded-xl font-bold text-[11px] hover:bg-orange-600 transition shadow-sm shadow-orange-500/20">
                            Book Now
