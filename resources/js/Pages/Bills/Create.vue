    ...
    <div class="py-4">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-4 flex items-center justify-between">
                <div>
                    <h2 class="text-xl font-black text-gray-900 tracking-tight">Add New Bill</h2>
                    <p class="text-[11px] text-gray-500 font-medium">Create and record a new billing entry quickly.</p>
                </div>
