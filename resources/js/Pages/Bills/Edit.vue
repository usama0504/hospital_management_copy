        ...
        <div class="py-6 sm:py-8">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-4 sm:mb-6 flex items-center justify-between gap-4">
                    <div>
                        <h2 class="text-xl sm:text-2xl font-black text-gray-900 tracking-tight">Edit Bill</h2>
                        <p class="text-[11px] sm:text-xs text-gray-500 font-medium">Update the billing and payment details for this record.</p>
                    </div>
