        ...
        <div class="py-6 sm:py-8">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-2xl font-black text-gray-900 tracking-tight">Edit Patient</h2>
                        <p class="text-xs text-gray-500 font-medium mt-0.5">Update the patient's information below.</p>
                    </div>
                ...
                <div v-if="Object.keys(form.errors).length > 0"
                    class="flex flex-col gap-1 bg-rose-50 border border-rose-200 text-rose-800 p-4 rounded-2xl text-xs font-semibold shadow-sm">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="date" id="dob" v-model="form.dob"
                                class="w-full bg-gray-50/50 border border-gray-200 rounded-xl px-4 py-3 text-xs font-medium text-gray-700 focus:outline-none focus:bg-white focus:border-orange-500 focus:ring-2 focus:ring-orange-500/25 transition" />
                            <div v-if="form.errors.dob" class="text-rose-600 text-[11px] mt-1 font-semibold">{{
                                form.errors.dob }}</div>
                        </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div v-if="form.errors.address" class="text-rose-600 text-[11px] mt-1 font-semibold">{{
