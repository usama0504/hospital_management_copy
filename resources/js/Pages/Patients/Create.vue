...
// Inertia useForm initialize kar rahe hain default values ke saath
const form = useForm({
    name: '',
    email: '',
    phone: '',
...
// Store form submission handler (POST request)
const submit = () => {
    ...
    <div class="py-4">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-xl font-black text-gray-900 tracking-tight">Add New Patient</h2>
