        ...
        <div class="py-4 sm:py-8">
            <div class="max-w-2xl mx-auto px-3 sm:px-6 lg:px-8 space-y-4 sm:space-y-6">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
                    <div class="min-w-0">
                        <h2 class="text-lg sm:text-2xl font-black text-gray-900 tracking-tight">Add Department</h2>
                        <p class="text-[11px] sm:text-xs text-gray-500 font-medium">Create a new hospital department.</p>
                    </div>
                    <Link :href="route('departments.index')" class="w-full sm:w-auto text-center text-xs font-bold text-gray-500 hover:text-gray-900 transition bg-white sm:bg-gray-50 px-3.5 py-2.5 sm:py-2 rounded-xl border border-gray-200 shadow-2xs shrink-0">
                        &larr; Back
                    </Link>
                </div>
                ...
                <form @submit.prevent="submit" class="bg-white border border-gray-100 shadow-sm rounded-2xl p-4 sm:p-6 space-y-4">
                    <div>
                        <label class="block text-[11px] font-bold text-gray-700 uppercase tracking-wider mb-1.5">Department Name</label>
                    ...
                    <div class="flex flex-col-reverse sm:flex-row items-center justify-end gap-2.5 pt-4 border-t border-gray-100">
                        <Link :href="route('departments.index')" class="w-full sm:w-auto text-center text-xs font-bold text-gray-500 hover:text-gray-900 transition px-4 py-2.5 rounded-xl border border-transparent hover:border-gray-200">
                            Cancel
                        </Link>
