    ...
    <AuthenticatedLayout>
        <div class="py-6">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div v-if="$page.props.flash?.success" class="mb-6 flex items-center gap-2 bg-emerald-50 border border-emerald-200 text-emerald-800 p-4 rounded-2xl text-xs font-semibold shadow-sm">
                ...
                <div class="bg-white border border-gray-100 shadow-sm rounded-2xl overflow-hidden">
                    ...
                    <div v-if="doctors.links && doctors.links.length > 3" class="p-4 border-t border-gray-100 bg-gray-50/50 flex items-center justify-between">
