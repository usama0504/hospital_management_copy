    ...
    <AuthenticatedLayout>
        <div class="py-6 sm:py-8">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div>
                        <Link :href="route('doctors.index')"
                            class="inline-flex items-center gap-2 bg-white text-gray-700 px-4 py-2.5 rounded-xl font-bold text-xs hover:bg-gray-50 transition border border-gray-200 shadow-sm">
                ...
                <div v-if="$page.props.flash?.success" class="p-4 rounded-2xl bg-emerald-50 text-emerald-800 text-xs font-semibold border border-emerald-200 flex items-center gap-2 shadow-sm">
                ...
                <div v-if="$page.props.flash?.error" class="p-4 rounded-2xl bg-rose-50 text-rose-800 text-xs font-semibold border border-rose-200 flex items-center gap-2 shadow-sm">
                    <svg class="w-5 h-5 text-rose-500 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z"/></svg>
                    <span>{{ $page.props.flash.error }}</span>
                </div>

                <!-- Validation Errors Alert -->
                <div v-if="Object.keys(form.errors).length > 0" class="p-4 rounded-2xl bg-rose-50 text-rose-800 text-xs font-semibold border border-rose-200 shadow-sm">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="p-6 border-b border-gray-100">
                        <h2 class="text-base font-bold text-gray-900">Add New Time Slot</h2>
                    </div>
                    ...
                    <form @submit.prevent="submit" class="p-6 space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            <!-- Day of Week -->
                            <div>
                                <label class="block text-[11px] font-bold text-gray-700 uppercase tracking-wider mb-1.5">Day of Week</label>
                            ...
                            <!-- Start Time -->
                            <div>
                                <label class="block text-[11px] font-bold text-gray-700 uppercase tracking-wider mb-1.5">Start Time</label>
                            ...
                            <!-- End Time -->
                            <div>
                                <label class="block text-[11px] font-bold text-gray-700 uppercase tracking-wider mb-1.5">End Time</label>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="p-6 border-b border-gray-100 flex items-center justify-between">
                        <div>
                            <h2 class="text-base font-bold text-gray-900">Active Slots</h2>
                            ...
                            <table class="min-w-full divide-y divide-gray-100 text-left">
                                <thead class="bg-gray-50/75 text-[11px] font-bold text-gray-500 uppercase tracking-wider">
                                    <tr>
                                        ...
                                        <th class="py-3.5 px-6">Timing Slot</th>
                                        <th class="py-3.5 px-6 text-right">Action</th>
                                    </tr>
                                </thead>
                                <tbody class="divide-y divide-gray-100 text-xs font-medium text-gray-700">
                                    <tr v-for="slot in availabilities" :key="slot.id" class="hover:bg-gray-50/50 transition">
                                        <td class="py-4 px-6">
                                            <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-[11px] font-bold bg-orange-50 text-orange-600 border border-orange-100">
                                                {{ slot.day_of_week }}
                                            </span>
                                        </td>
                                        <td class="py-4 px-6 font-semibold text-gray-900 flex items-center gap-1.5 mt-0.5">
