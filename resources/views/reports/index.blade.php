...
@section('content')
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Header Section -->
            <div class="mb-6">
                <h2 class="text-2xl font-black text-gray-900 tracking-tight">{{ __('Hospital Reports') }}</h2>
                ...
                <form method="GET" action="{{ route('reports.index') }}" class="flex flex-col sm:flex-row items-end gap-4">
                    ...
                    <div class="flex items-center gap-2 w-full sm:w-auto">
                        ...
                        @if(!empty($from) || !empty($to))
                            <a href="{{ route('reports.index') }}" class="text-xs font-bold text-gray-500 hover:text-gray-900 transition px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl">
                                Reset
                            </a>
                        @endif
                    </div>
