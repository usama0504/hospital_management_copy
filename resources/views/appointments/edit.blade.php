...
@section('content')
    <div class="py-6">
        <div class="max-w-3xl mx-auto px-6">
            ...
            <!-- Header Section -->
            <div class="mb-8">
                <h2 class="text-3xl font-extrabold text-gray-900">{{ __('Edit Appointment') }}</h2>
            </div>
            ...
            <form action="{{ route('appointments.update', $appointment->id) }}" method="POST" class="bg-white p-6 rounded shadow">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <input type="datetime-local" name="appointment_date" id="appointment_date"
                        ...
                        required class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400" />
                </div>
                ...
                <div>
                    <button type="submit" class="bg-indigo-600 text-white rounded px-4 py-2 hover:bg-indigo-700">Update Appointment</button>
