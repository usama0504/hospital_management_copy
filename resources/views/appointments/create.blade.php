    ...
    <div class="py-6 sm:py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-4 sm:mb-6 flex items-center justify-between gap-4">
                <div>
                    <h2 class="text-xl sm:text-2xl font-black text-gray-900 tracking-tight">{{ __('Add Appointment') }}</h2>
            ...
            <!-- Form Card Container -->
            <form action="{{ route('appointments.store') }}" method="POST" class="bg-white border border-gray-100 shadow-sm rounded-2xl p-4 sm:p-6 space-y-4">
                @csrf
