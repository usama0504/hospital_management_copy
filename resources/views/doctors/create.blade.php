    ...
    <div class="py-4">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-4 flex items-center justify-between">
                <div>
                    <h2 class="text-xl font-black text-gray-900 tracking-tight">{{ __('Add New Doctor') }}</h2>
                    <p class="text-[11px] text-gray-500 font-medium">Add a new doctor to the hospital system.</p>
                </div>
                <a href="{{ route('doctors.index') }}" class="text-xs font-bold text-gray-500 hover:text-gray-900 transition bg-gray-50 px-3 py-1.5 rounded-lg border border-gray-200">
                    &larr; Back
                </a>
            </div>
            ...
            <form action="{{ route('doctors.store') }}" method="POST" class="bg-white border border-gray-100 shadow-sm rounded-2xl p-5 sm:p-6 space-y-4">
                @csrf
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="password" name="password" id="password" required
                            class="w-full bg-gray-50/50 border border-gray-200 rounded-xl px-3.5 py-2.5 text-xs font-medium text-gray-700 focus:outline-none focus:bg-white focus:border-orange-500 focus:ring-2 focus:ring-orange-500/25 transition" placeholder="Minimum 6 characters" />
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3 pt-3 border-t border-gray-100">
                    ...
                    <a href="{{ route('doctors.index') }}" class="text-xs font-bold text-gray-500 hover:text-gray-900 transition px-3 py-2">
                        Cancel
                    </a>
                </div>
            </form>
