...
<body class="bg-gray-50/50 font-sans antialiased text-gray-800" style="font-family: 'Poppins', sans-serif;"
    ...
    @if (request()->routeIs('login') || request()->routeIs('register'))
        ...
        <div class="min-h-screen flex flex-col justify-between bg-gray-50/50">
            ...
            <!-- Simple Top Header -->
            <header
                class="w-full bg-white border-b border-gray-100 py-4 px-6 sm:px-12 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <div
                        class="w-9 h-9 rounded-xl bg-orange-500 text-white flex items-center justify-center font-bold shadow-sm shadow-orange-500/30 text-base">
                        🏥
                    </div>
        ...
        <div class="flex h-screen overflow-hidden">
            ...
            <aside class="hidden md:flex flex-col w-64 bg-white border-r border-gray-100 z-20">
                ...
                <nav class="flex-1 px-4 py-6 space-y-1.5 overflow-y-auto text-xs font-semibold">
                    ...
                    <!-- Settings / Profile Link Added Here -->
                    ...
                    <div class="flex items-center gap-4">
                        @auth
                            <div class="flex items-center gap-3 pl-4 border-l border-gray-100">
                                <!-- Dynamic Profile Image from Storage (with Initials Fallback) -->
                                @if(auth()->user()->profile_photo_path)
                                    <img src="{{ asset('storage/' . auth()->user()->profile_photo_path) }}"
                                        alt="{{ auth()->user()->name }}"
                                        class="w-10 h-10 rounded-full object-cover shadow-sm border border-gray-200">
                                @else
                                    <div class="w-10 h-10 rounded-full bg-orange-500 text-white flex items-center justify-center font-bold text-xs shadow-sm">
