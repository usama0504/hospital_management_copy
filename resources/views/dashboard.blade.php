                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-xs font-semibold text-gray-400 tracking-wider uppercase mt-1">New Patients
                                </p>
                            </div>
                            ...
                            <div
                                ...
                                <div>
                                    <p class="text-2xl font-black text-gray-900">
                                        ${{ number_format($totalEarnings ?? 0, 2) }}</p>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
                        ...
                        <div class="flex flex-wrap items-center gap-4 text-xs font-semibold text-gray-500">
                            <span class="flex items-center gap-2"><span class="w-3 h-3 rounded-full bg-orange-400"></span>
                                Patients 2019</span>
                            <span class="flex items-center gap-2"><span class="w-3 h-3 rounded-full bg-indigo-600"></span>
                                Patients 2020</span>
                        </div>
                    </div>
                    <div
                        class="h-60 w-full bg-gray-50/50 rounded-xl border border-dashed border-gray-200 flex flex-col items-center justify-center text-gray-400 text-sm">
                        <svg class="w-10 h-10 text-gray-300 mb-2" fill="none" stroke="currentColor" stroke-width="1.5"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div class="space-y-3 pt-2 text-xs font-semibold">
                        <div class="flex items-center justify-between text-gray-600">
                            <span class="flex items-center gap-2"><span class="w-2.5 h-2.5 rounded-full bg-rose-400"></span>
                                Cardiology</span>
                            <span class="text-gray-900 font-bold">40%</span>
                        </div>
                        <div class="flex items-center justify-between text-gray-600">
                            <span class="flex items-center gap-2"><span
                                    class="w-2.5 h-2.5 rounded-full bg-indigo-600"></span> Neurology</span>
                            <span class="text-gray-900 font-bold">30%</span>
                        </div>
                        <div class="flex items-center justify-between text-gray-600">
                            <span class="flex items-center gap-2"><span
                                    class="w-2.5 h-2.5 rounded-full bg-amber-400"></span> Dermatology</span>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                        ...
                        <a href="{{ route('doctors.index') }}"
                            class="text-xs text-orange-500 font-semibold hover:underline">View All</a>
                    </div>
                            ...
                            <div class="px-6 py-3.5 flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-[11px] text-gray-400">{{ $doctor->specialization ?? 'Specialist' }}
                                        </p>
                                    </div>
                                </div>
                                <span
                        ...
                        <tbody class="divide-y divide-gray-100 text-gray-600">
                            @forelse($recentAppointments ?? [] as $appointment)
                                <tr class="hover:bg-gray-50/40 transition">
                                    ...
                                    <td
                                        class="py-4 px-4 sm:px-6 font-bold text-gray-800 text-xs sm:text-sm whitespace-nowrap">
            ...
            <div class="grid grid-cols-1 gap-6">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                        ...
                        <span class="text-xs text-rose-500 font-bold">Total Earnings:
                            ${{ number_format($totalEarnings ?? 0, 2) }}</span>
                    </div>
                                ...
                                @forelse($recentBills ?? [] as $bill)
                                    <tr class="hover:bg-gray-50/40 transition">
                                        ...
                                        <td class="py-4 px-6 text-xs">
                                            ...
                                            @else
                                                <span
                                                    class="px-2.5 py-1 bg-amber-50 text-amber-600 rounded-full font-bold">{{ ucfirst($bill->status) }}</span>
                                            @endif
                                        </td>
